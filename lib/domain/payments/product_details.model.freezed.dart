...
class _$_ProductDetails implements _ProductDetails {
  ...
  @override
  String toString() {
    return 'ProductDetails(id: $id, title: $title, description: $description, price: $price, rawPrice: $rawPrice, currencyCode: $currencyCode, currencySymbol: $currencySymbol, isFree: $isFree)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, price,
      rawPrice, currencyCode, currencySymbol, isFree);
...
abstract class _ProductDetails implements ProductDetails {
  const factory _ProductDetails(
      ...
      final String? currencySymbol,
      final bool isFree}) = _$_ProductDetails;
